...
class Casrel(nn.Module):
    def __init__(self, config):
        ...
        self.config = config
        self.bert_dim = 768
        self.bert_encoder = BertModel.from_pretrained("data/bert-base-cased")
    ...
    def get_objs_for_specific_sub(self, sub_head_mapping, sub_tail_mapping, encoded_text):
        ...
        sub_head = torch.matmul(sub_head_mapping, encoded_text)     # [batch_size, 1, seq_len] * [batch_size, seq_len, bert_dim(768)], 得到subject的head embedding
        sub_tail = torch.matmul(sub_tail_mapping, encoded_text)     # 得到subject的tail embedding
        ...
        '''
            [batch_size, seq_len, bert_dim(768)] + [batch_size, 1, bert_dim]
            将bert输出和当前subject的向量相加，相当于在每个字符中，融入了subject的信息，以便下一步提取object
        '''
